...
// Mini footer utilisé dans les dashboards (inchangé)
    ...
    <div className="lp-footer-top">
      ...
      <div className="lp-footer-brand">
        ...
        <p className="lp-footer-tagline">
          La plateforme qui connecte les particuliers aux prestataires locaux en
          temps réel, partout en Nouvelle-Calédonie.
        </p>
      </div>
