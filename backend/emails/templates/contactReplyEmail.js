// backend/emails/templates/contactReplyEmail.js
// Email envoyé au visiteur quand l'admin répond
const generateContactReplyEmail = ({ nom, sujetOriginal, messageOriginal, reponse, adminPrenom }) => `
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1.0"/>
  <title>Réponse à votre message — Hopela</title>
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .reponse-block{background:#1c1409;border-radius:12px;padding:24px;margin-bottom:24px;}
    .reponse-label{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#7a6a54;margin-bottom:12px;}
    .reponse-text{font-size:14px;color:#f5f0eb;line-height:1.8;white-space:pre-wrap;}
    .reponse-sign{margin-top:16px;font-size:12px;color:#7a6a54;font-style:italic;}
    .original{background:#f0ebe3;border:1px solid #e0d5c5;border-radius:10px;padding:16px;margin-bottom:24px;}
    .original-label{font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:#a89070;margin-bottom:8px;}
    .original-text{font-size:12px;color:#9a8a78;line-height:1.7;white-space:pre-wrap;}
...
<div class="wrap">
  <div class="header">
    ...
    <h1>Réponse à votre <em>message</em></h1>
    <p>L'équipe Hopela vous a répondu.</p>
  </div>
  <div class="divider"></div>
  <div class="body">
    <p class="greeting">Bonjour ${nom},</p>
    <p class="text">L'équipe Hopela a répondu à votre demande concernant <strong>"${sujetOriginal}"</strong>.</p>
    <div class="reponse-block">
      <div class="reponse-label">Notre réponse</div>
      <div class="reponse-text">${reponse}</div>
      <div class="reponse-sign">— ${adminPrenom}, Équipe Hopela</div>
    </div>
    <div class="original">
      <div class="original-label">Votre message d'origine</div>
      <div class="original-text">${messageOriginal}</div>
    </div>
  </div>
  <div class="footer">
...
`;
export default generateContactReplyEmail;